...
ICSD_CREDENTIALS_JSON = str(HERE/"DATA/icsd_credentials.json")
...
class ICSD_Session():
    ...
    def writeout(self, cifs, folder= HERE/"DATA/cifs/ICSD/"):
        ...
        for cif in cifs:
            ...
            filename = f"{int(icsd_code):06}.cif"
...
def download_all(loginid, password, min_N=1, max_N=1):
